    ...
    <div style={{ background: c.cream, color: c.ink, fontFamily: sans, fontWeight: 300, overflowX: 'hidden' }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '2.5rem' }}>
          <Link href="#how" style={{ fontFamily: mono, fontSize: '0.78rem', letterSpacing: '0.06em', textTransform: 'uppercase', color: c.inkSoft, textDecoration: 'none' }}>
            How it works
          </Link>
          <Link href="/education" style={{ fontFamily: mono, fontSize: '0.78rem', letterSpacing: '0.06em', textTransform: 'uppercase', color: c.inkSoft, textDecoration: 'none' }}>
            Learn
          </Link>
          <Link href="/sign-in" style={{ fontFamily: mono, fontSize: '0.78rem', letterSpacing: '0.06em', textTransform: 'uppercase', color: c.inkSoft, textDecoration: 'none' }}>
            Sign in
          </Link>
          <Link href="/sign-up" style={{
            fontFamily: mono, fontSize: '0.78rem', letterSpacing: '0.06em', textTransform: 'uppercase',
            background: c.green, color: c.cream, padding: '0.5rem 1.25rem', borderRadius: '2px', textDecoration: 'none',
          }}>
            Get Started
          </Link>
        </div>
      ...
      <section style={{ minHeight: '100vh', display: 'grid', gridTemplateColumns: '1fr 1fr', paddingTop: '5rem' }}>
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '5rem 3rem', borderRight: `0.5px solid ${c.border}` }}>
          ...
          <h1 style={{ fontFamily: serif, fontSize: 'clamp(3rem, 5vw, 4.5rem)', lineHeight: 1.08, letterSpacing: '-0.03em', marginBottom: '1.75rem', fontWeight: 400 }}>
            Invest with{' '}
            <em style={{ fontStyle: 'italic', color: c.green }}>intention,</em>
            {' '}not guesswork.
          </h1>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem' }}>
            <Link href="/sign-up" style={{
              background: c.green, color: c.cream, padding: '0.85rem 2rem',
              fontFamily: mono, fontSize: '0.8rem', letterSpacing: '0.06em', textTransform: 'uppercase',
              borderRadius: '2px', textDecoration: 'none', display: 'inline-block',
            }}>
              Start for free
            </Link>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '5rem 3rem' }}>
          <div style={{ background: c.green, padding: '2.5rem', borderRadius: '2px' }}>
            <p style={{ fontFamily: mono, fontSize: '0.65rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(245,242,235,0.5)', marginBottom: '1.25rem' }}>
              Sample portfolio — Conservative
            </p>
            {[
              { label: 'US Bonds', pct: 40 },
              { label: 'ETFs', pct: 30 },
              { label: 'Div. Stocks', pct: 20 },
              { label: 'Cash', pct: 10 },
            ].map(({ label, pct }) => (
            ...
            <p style={{ marginTop: '1rem', fontFamily: mono, fontSize: '0.7rem', color: 'rgba(245,242,235,0.3)', fontStyle: 'italic' }}>
              Your allocation is built from your onboarding survey.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* FEATURES */}
      <section style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', borderTop: `0.5px solid ${c.border}` }}>
        {[
          {
            num: '01', title: 'AI-built portfolios',
            body: 'Your risk profile, goals, and timeline shape a portfolio designed specifically for you — Conservative, Balanced, or Aggressive.',
            icon: <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" />,
          },
          {
            num: '02', title: 'Education that fits you',
            body: 'Lessons are curated to your portfolio type and experience level. You learn about what you own, not random finance theory.',
            icon: <path d="M2 20h20M4 20V10l8-6 8 6v10M10 20v-5h4v5" />,
          },
          {
            num: '03', title: 'Paper trading first',
            body: 'Start with a simulated $10,000 portfolio. Practice making decisions in real market conditions before any real money is involved.',
            icon: <><circle cx="12" cy="12" r="10" /><path d="M12 8v4l3 3" /></>,
          },
          {
            num: '04', title: 'Built for students',
            body: 'Designed around your reality — irregular income, student loans, and a long time horizon are features, not problems to work around.',
      ...
      {/* HOW IT WORKS */}
      <section id="how" style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', borderTop: `0.5px solid ${c.border}` }}>
        <div style={{ padding: '4rem 3rem', borderRight: `0.5px solid ${c.border}`, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          ...
          <h2 style={{ fontFamily: serif, fontSize: '2.5rem', lineHeight: 1.15, letterSpacing: '-0.03em', fontWeight: 400 }}>
      ...
      {/* BETA DISCLAIMER */}
      <div style={{ borderTop: `0.5px solid ${c.border}`, padding: '2rem 3rem', display: 'flex', alignItems: 'center', gap: '1rem', background: '#faf8f2' }}>
      ...
      {/* CTA STRIP */}
      <div style={{ background: c.green, padding: '5rem 3rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '2rem' }}>
        <h2 style={{ fontFamily: serif, fontSize: 'clamp(2rem, 4vw, 3rem)', color: c.cream, fontWeight: 400, letterSpacing: '-0.03em', maxWidth: '560px', lineHeight: 1.15 }}>
          Ready to stop guessing and start{' '}
          <em style={{ fontStyle: 'italic', color: '#a8d4b8' }}>growing?</em>
        </h2>
        <Link href="/sign-up" style={{
          background: c.cream, color: c.green, padding: '0.9rem 2.25rem',
          fontFamily: mono, fontSize: '0.8rem', letterSpacing: '0.06em', textTransform: 'uppercase',
      ...
      {/* FOOTER */}
      <footer style={{ borderTop: `0.5px solid ${c.border}`, padding: '3rem' }}>
        ...
        <div style={{ paddingTop: '2rem', borderTop: `0.5px solid ${c.border}`, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <p style={{ fontFamily: mono, fontSize: '0.68rem', color: c.inkMuted, letterSpacing: '0.04em' }}>
            Built by Miles Smith · Co founders:  Vaska Wysocki · Aaniya Ahuja 
          </p>
          <p style={{ fontFamily: mono, fontSize: '0.68rem', color: c.inkMuted }}>
            © {new Date().getFullYear()} Allorca
          </p>
        </div>
      </footer>
